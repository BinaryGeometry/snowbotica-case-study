...
### The next part is really difficult. 

We want to use the same code, but we want to use it on an individual widget. the things being widgets dont behave the same way as options pages, since the angular code needs to be loaded on the instantiation of a new widget, and there isnt a native wordpress hook into this behavior. We inspect the eventwe look at wp-admin/widgets.php and find the the code includes an `_wpnonce_widgets` object. We know that wordpress uses this for verifying ajax calls so searching for it we find wp-admin/js/widgets.js. 

Inspecting the dashboard markup generated by wordpress from our config above we have the following.


```
<div id="tz_slideshow_widget_area" class="widgets-sortables ui-droppable ui-sortable">    
  <div class="sidebar-name">
      <div class="sidebar-name-arrow"><br></div>
      <h2>Frontpage Slideshow Area <span class="spinner"></span></h2>
  </div>
  
  <div id="widget-24_tz_slideshow_widget-4" class="widget"> <div class="widget-top">
    <div class="widget-title-action">
      <button type="button" class="widget-action hide-if-no-js" aria-expanded="false">
        <span class="screen-reader-text">Edit widget: DynamicSlideshow</span>
        <span class="toggle-indicator" aria-hidden="true"></span>
      </button>
      <a class="widget-control-edit hide-if-js" href="/wp-admin/widgets.php?editwidget=tz_slideshow_widget-4&amp;sidebar=tz_slideshow_widget_area&amp;key=1">
        <span class="edit">Edit</span>
        <span class="add">Add</span>
        <span class="screen-reader-text">DynamicSlideshow</span>
      </a>
    </div>
    <div class="widget-title ui-sortable-handle"><h3>DynamicSlideshow<span class="in-widget-title">: TZ Slideshow</span></h3></div>
  </div>
</div>
